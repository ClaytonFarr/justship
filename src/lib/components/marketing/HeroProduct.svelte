...
<template lang="pug">
  .relative.isolate.overflow-hidden.bg-surface-lightest
    Pattern01(
      strokeWidthClass='stroke-2',
      strokeColorClass='stroke-rule-light',
    ...
    Container(additionalClasses='pb-24 pt-10 sm_pb-32 lg_flex lg_py-40')
